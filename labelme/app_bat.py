...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        #唯一标签面板（UniqueLabelQListWidget）
        self.uniqLabelList = UniqueLabelQListWidget()
        self.uniqLabelList.setcolor(self._get_rgb_by_label)
        self.uniqLabelList.setShortcutCallback(self.select_item)
        ...
        self.uniqLabelList.selectFirstItemIfNotEmpty()
        self.uniqLabelList.itemSelectionChangedSignal.connect(self.emitCurrentItemChanged)
        ...
        self.canvas.current_label=self.uniqLabelList.getCurrentItem().data(Qt.UserRole)
        #中心滚动区域
        ...
        self.canvas.contact_del_shape.connect(self.remLabels)
        ...
        duplicate = action(
            self.tr("Duplicate Polygons"),#也是复制？
    ...
    def toggleDrawMode(self, edit=True, createMode="polygon"):
        draw_actions = {
            ...
            "pen":self.actions.createBrush,# type: ignore[attr-defined]
            "eraser": self.actions.createEraser,  # type: ignore[attr-defined]
        }
    ...
    def labelSelectionChanged(self):
        '''作用: 当标签列表中选中项发生变化时，更新 canvas 中选中的图形。'''
    ...
    def labelItemChanged(self, item):
        '''作用: 当标签列表中的 item 被勾选/取消勾选时，设置对应图形是否可见。'''
        shape = item.shape()
...
"""
    ...
    def save_pixmap(self):
        self.canvas.pixmap2.save('aaa.png')